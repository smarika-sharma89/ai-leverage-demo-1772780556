  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-sky-50 border border-sky-200 rounded-lg p-4 text-sm text-sky-800">
        <strong>What was built:</strong> The Varicon Financial Integrity Team met with Jess to understand long-standing client pain points, many of which have been raised since May of the previous year without resolution. Key issues centre around the three-phase bill approval workflow, GST rounding discrepancies, bill syncing errors with Xero, and Day Works functionality gaps. The meeting resulted in several agreed next steps including design mock-ups for approval visibility and investigation into charge rate management within the platform.
